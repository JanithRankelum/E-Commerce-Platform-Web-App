...
import P001 from "../../../Electronics/assets/Images/Category/Skin/Skin001.jpg";
import P002 from "../../../Electronics/assets/Images/Category/Skin/Skin002.jpg";
import P003 from "../../../Electronics/assets/Images/Category/Skin/Skin003.jpg";
import P004 from "../../../Electronics/assets/Images/Category/Skin/Skin004.jpg";
import P005 from "../../../Electronics/assets/Images/Category/Skin/Skin005.jpg";
import P006 from "../../../Electronics/assets/Images/Category/Skin/Skin006.jpg";
...
const Skincare = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch("http://localhost:8000/get-skincare");

...
const Healthw = () => {
    ...
    const fetchProducts = async () => {
      try {
        const response = await fetch(
          "http://localhost:8000/get-healthandwellness"
        );
  ...
  return (
    <section className="phones-page">
      <h1>Health & Wellness Category</h1>
      <p>Support your lifestyle with our health and wellness products.</p>

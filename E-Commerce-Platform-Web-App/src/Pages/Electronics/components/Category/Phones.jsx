...
import P001 from "../../../Electronics/assets/Images/Category/Phones/P001.jpg";
import P002 from "../../../Electronics/assets/Images/Category/Phones/P002.jpg";
...
import P005 from "../../../Electronics/assets/Images/Category/Phones/P005.jpg";
import P006 from "../../../Electronics/assets/Images/Category/Phones/P006.jpg";
import P007 from "../../../Electronics/assets/Images/Category/Phones/P007.jpg";
...
const Phones = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch("http://localhost:8000/get-phones");
